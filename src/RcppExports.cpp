...
// UTF-32 nanodbc variant entry points, generated by compiling the same sources with NANODBC_USE_IODBC_WIDE_STRINGS.
RcppExport SEXP _odbc_list_drivers__utf32();
RcppExport SEXP _odbc_list_data_sources__utf32();
RcppExport SEXP _odbc_odbc_connect_utf32(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_has_result_utf32(SEXP);
RcppExport SEXP _odbc_connection_info_utf32(SEXP);
RcppExport SEXP _odbc_connection_quote_utf32(SEXP);
RcppExport SEXP _odbc_connection_release_utf32(SEXP);
RcppExport SEXP _odbc_connection_begin_utf32(SEXP);
RcppExport SEXP _odbc_connection_commit_utf32(SEXP);
RcppExport SEXP _odbc_connection_rollback_utf32(SEXP);
RcppExport SEXP _odbc_connection_valid_utf32(SEXP);
RcppExport SEXP _odbc_connection_sql_tables_utf32(SEXP, SEXP, SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_connection_sql_catalogs_utf32(SEXP);
RcppExport SEXP _odbc_connection_sql_schemas_utf32(SEXP);
RcppExport SEXP _odbc_connection_sql_table_types_utf32(SEXP);
RcppExport SEXP _odbc_connection_sql_columns_utf32(SEXP, SEXP, SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_transactionLevels_utf32();
RcppExport SEXP _odbc_set_transaction_isolation_utf32(SEXP, SEXP);
RcppExport SEXP _odbc_bigint_mappings_utf32();
RcppExport SEXP _odbc_result_release_utf32(SEXP);
RcppExport SEXP _odbc_result_active_utf32(SEXP);
RcppExport SEXP _odbc_result_completed_utf32(SEXP);
RcppExport SEXP _odbc_new_result_utf32(SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_result_fetch_utf32(SEXP, SEXP);
RcppExport SEXP _odbc_result_column_info_utf32(SEXP);
RcppExport SEXP _odbc_result_bind_utf32(SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_result_insert_dataframe_utf32(SEXP, SEXP, SEXP);
RcppExport SEXP _odbc_result_describe_parameters_utf32(SEXP, SEXP);
RcppExport SEXP _odbc_result_rows_affected_utf32(SEXP);
RcppExport SEXP _odbc_result_row_count_utf32(SEXP);
RcppExport SEXP _odbc_column_types_utf32(SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_odbc_list_drivers__utf32", (DL_FUNC) &_odbc_list_drivers__utf32, 0},
    {"_odbc_list_data_sources__utf32", (DL_FUNC) &_odbc_list_data_sources__utf32, 0},
    {"_odbc_odbc_connect_utf32", (DL_FUNC) &_odbc_odbc_connect_utf32, 9},
    {"_odbc_has_result_utf32", (DL_FUNC) &_odbc_has_result_utf32, 1},
    {"_odbc_connection_info_utf32", (DL_FUNC) &_odbc_connection_info_utf32, 1},
    {"_odbc_connection_quote_utf32", (DL_FUNC) &_odbc_connection_quote_utf32, 1},
    {"_odbc_connection_release_utf32", (DL_FUNC) &_odbc_connection_release_utf32, 1},
    {"_odbc_connection_begin_utf32", (DL_FUNC) &_odbc_connection_begin_utf32, 1},
    {"_odbc_connection_commit_utf32", (DL_FUNC) &_odbc_connection_commit_utf32, 1},
    {"_odbc_connection_rollback_utf32", (DL_FUNC) &_odbc_connection_rollback_utf32, 1},
    {"_odbc_connection_valid_utf32", (DL_FUNC) &_odbc_connection_valid_utf32, 1},
    {"_odbc_connection_sql_tables_utf32", (DL_FUNC) &_odbc_connection_sql_tables_utf32, 5},
    {"_odbc_connection_sql_catalogs_utf32", (DL_FUNC) &_odbc_connection_sql_catalogs_utf32, 1},
    {"_odbc_connection_sql_schemas_utf32", (DL_FUNC) &_odbc_connection_sql_schemas_utf32, 1},
    {"_odbc_connection_sql_table_types_utf32", (DL_FUNC) &_odbc_connection_sql_table_types_utf32, 1},
    {"_odbc_connection_sql_columns_utf32", (DL_FUNC) &_odbc_connection_sql_columns_utf32, 5},
    {"_odbc_transactionLevels_utf32", (DL_FUNC) &_odbc_transactionLevels_utf32, 0},
    {"_odbc_set_transaction_isolation_utf32", (DL_FUNC) &_odbc_set_transaction_isolation_utf32, 2},
    {"_odbc_bigint_mappings_utf32", (DL_FUNC) &_odbc_bigint_mappings_utf32, 0},
    {"_odbc_result_release_utf32", (DL_FUNC) &_odbc_result_release_utf32, 1},
    {"_odbc_result_active_utf32", (DL_FUNC) &_odbc_result_active_utf32, 1},
    {"_odbc_result_completed_utf32", (DL_FUNC) &_odbc_result_completed_utf32, 1},
    {"_odbc_new_result_utf32", (DL_FUNC) &_odbc_new_result_utf32, 3},
    {"_odbc_result_fetch_utf32", (DL_FUNC) &_odbc_result_fetch_utf32, 2},
    {"_odbc_result_column_info_utf32", (DL_FUNC) &_odbc_result_column_info_utf32, 1},
    {"_odbc_result_bind_utf32", (DL_FUNC) &_odbc_result_bind_utf32, 3},
    {"_odbc_result_insert_dataframe_utf32", (DL_FUNC) &_odbc_result_insert_dataframe_utf32, 3},
    {"_odbc_result_describe_parameters_utf32", (DL_FUNC) &_odbc_result_describe_parameters_utf32, 2},
    {"_odbc_result_rows_affected_utf32", (DL_FUNC) &_odbc_result_rows_affected_utf32, 1},
    {"_odbc_result_row_count_utf32", (DL_FUNC) &_odbc_result_row_count_utf32, 1},
    {"_odbc_column_types_utf32", (DL_FUNC) &_odbc_column_types_utf32, 1},
    {NULL, NULL, 0}
};
